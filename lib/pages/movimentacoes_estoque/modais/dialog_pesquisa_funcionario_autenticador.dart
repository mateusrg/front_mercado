...
class DialogPesquisaFuncionarioAutenticador extends StatefulWidget {
  const DialogPesquisaFuncionarioAutenticador({super.key});

  @override
  State<DialogPesquisaFuncionarioAutenticador> createState() =>
      _DialogPesquisaFuncionarioAutenticadorState();
}

class _DialogPesquisaFuncionarioAutenticadorState
    extends State<DialogPesquisaFuncionarioAutenticador> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Pesquisar Funcionário Autenticador'),
      content: Column(
